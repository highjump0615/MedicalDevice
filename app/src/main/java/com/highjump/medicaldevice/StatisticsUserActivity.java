...
public class StatisticsUserActivity extends HistoryActivity {

    private StatUserAdapter mAdapter;

    ArrayList<User> maryData = new ArrayList<User>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new StatUserAdapter(this, maryData);
    ...
    public void getData(final boolean bRefresh) {
        ...
        // 调用相应的API
        APIManager.getInstance().getUserList(
                ...
                new Callback() {
                    ...
                    public void onFailure(Call call, final IOException e) {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                stopRefresh();
                                Toast.makeText(StatisticsUserActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                        ...
                        if (!response.isSuccessful()) {
                            ...
                            try {
                                ...
                                if (!resultObj.isSuccess()) {
                                    ...
                                    // 总数量
                                    mnTotalCount = jsonRes.getInt("memberTotal");

                                    // 记录
                                    JSONArray aryJson = jsonRes.getJSONArray("members");
                                    for (int i = 0; i < aryJson.length(); i++) {
                                        JSONObject jsonObj = aryJson.getJSONObject(i);
                                        User newUser = new User(jsonObj);
                                        maryData.add(newUser);
                                    }
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (!mstrApiErr.isEmpty()) {
                                    Toast.makeText(StatisticsUserActivity.this, mstrApiErr, Toast.LENGTH_SHORT).show();
                                    return;
                                }
